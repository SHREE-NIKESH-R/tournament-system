      ...
      <aside className="w-60 shrink-0 flex flex-col glass border-r border-white/5 sticky top-0 h-screen">
          ...
          {navItems.map(({ to, icon: Icon, label, exact }) => {
            ...
            return (
              ...
              >
                ...
                <span className="font-[Orbitron] text-xs uppercase tracking-wider">{label}</span>
        ...
        <div className="p-3 space-y-1 border-t border-white/5">
          ...
          >
            ...
            <span className="font-[Orbitron] text-xs uppercase tracking-wider">Public View</span>
          </Link>
          <button
          ...
          >
            ...
            <span className="font-[Orbitron] text-xs uppercase tracking-wider">Sign Out</span>
          </button>
        </div>
      </aside>
