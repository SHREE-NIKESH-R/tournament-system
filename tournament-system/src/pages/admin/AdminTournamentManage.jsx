  ...
  return (
    ...
    >
      <div className="grid grid-cols-[1fr_auto_1fr] gap-3 items-stretch">
        <div
          className={`px-4 py-3 flex items-center gap-2 transition-colors ${p1Wins ? "bg-neon-cyan/10" : ""}`}
        >
        ...
        <div
          className={`px-4 py-3 flex items-center gap-2 justify-end transition-colors ${p2Wins ? "bg-neon-cyan/10" : ""}`}
        >
          {p2Wins && (
            <Trophy className="w-4 h-4 text-neon-cyan shrink-0 drop-shadow-[0_0_8px_rgba(6,214,245,0.7)]" />
          )}
