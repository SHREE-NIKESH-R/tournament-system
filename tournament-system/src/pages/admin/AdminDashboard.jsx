...
import { Plus, Trophy, Swords, Settings, CheckCircle, Clock } from 'lucide-react'
...
export default function AdminDashboard() {
  ...
  const [createType, setCreateType] = useState(null) // 'league' | 'knockout' | null
    ...
    <PageTransition>
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <div className="flex gap-2">
          <Button variant="purple" size="sm" onClick={() => setCreateType('league')}>
            <Trophy className="w-4 h-4" />
            New League
          </Button>
          <Button variant="cyan" size="sm" onClick={() => setCreateType('knockout')}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-semibold text-white/90 text-sm truncate">{t.name}</span>
                    </div>
